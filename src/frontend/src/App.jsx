    ...
    <div className="app">
      ...
      <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="container navbar-content">
          <div className="logo">
            ...
            <span>Aero<span className="text-copper">Intel</span></span>
          </div>
          ...
          <div className="nav-actions">
            <button className="btn btn-primary d-none-mobile">
        ...
        <div className="container">
          <div className="section-header reveal">
            ...
            <p className="hero-description" style={{ margin: '0 auto' }}>
              From raw sensor data to real-time insights, AeroIntel helps you predict failures, optimize maintenance, and keep your fleet ready for what's next.
            </p>
          </div>
      ...
      <footer className="footer">
        <div className="container">
          ...
          <p>© 2026 AeroIntel. Defense & Aerospace Mission Readiness Copilot.</p>
        </div>
      </footer>
    </div>
  );
